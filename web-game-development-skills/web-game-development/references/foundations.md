...
Establish the non-negotiable architecture before implementation starts. Browser games degrade quickly when simulation, rendering, UI, asset loading, and input handling are mixed together.
...
- the engine or renderer choice is not yet settled
- the task is about boundaries, module shape, state ownership, or asset policy
- multiple domains need one shared architectural frame

## Hand off when

- the runtime track is clearly Phaser (`./phaser-2d.md`)
- the runtime track is clearly vanilla Three.js (`./three-webgl.md`)
- the runtime track is clearly React Three Fiber (`./react-three-fiber.md`)
- the task is purely about shipped 3D assets (`./asset-pipeline-3d.md`)
...
See `./engine-selection.md` for the default decision table.
...
- Phaser structure: `./phaser-architecture.md`
- Three.js structure: `./three-webgl-architecture.md`
- Three.js ecosystem stack: `./threejs-stack.md`
- React Three Fiber stack: `./react-three-fiber-stack.md`
- 3D asset shipping: `./web-3d-asset-pipeline.md`
