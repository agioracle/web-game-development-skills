...
The main execution path for browser games in this skill. Phaser is the default stack for 2D browser games because it handles rendering, timing, sprites, cameras, and scene orchestration well without forcing gameplay rules into the framework.
...
See `./phaser-architecture.md` for a concrete module split.
...
- Sprite workflow: `./sprite-workflow.md`
