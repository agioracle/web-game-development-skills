...
Use this guide to test browser games the way players experience them: through boot, input, scene transitions, HUD readability, and visual state changes. Prefer browser automation and screenshot review when the project supports it.
...
- Frontend review cues: `./ui-frontend.md`
- 3D debugging notes: `./webgl-debugging-and-performance.md`
- Full checklist: `./playtest-checklist.md`
