...
Use this guide whenever the game needs a visible interface layer. The job is not to produce generic dashboard UI. The job is to produce a readable, thematic browser-game interface that supports the play experience.
...
Use `./frontend-prompts.md` for concrete prompt shapes.
...
- Prompt recipes: `./frontend-prompts.md`
- Low-chrome 3D layout patterns: `./three-hud-layout-patterns.md`
- React-hosted 3D UI context: `./react-three-fiber.md`
- Playtest review: `./playtest-checklist.md`
