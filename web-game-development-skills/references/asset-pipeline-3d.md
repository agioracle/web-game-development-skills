...
Use this guide for shipped 3D assets, not runtime scene code. The default output format for browser 3D work is GLB or glTF 2.0. The goal is predictable runtime assets, not whatever the DCC tool happened to export first.
...
- Three.js stack: `./threejs-stack.md`
...
- 3D asset pipeline reference: `./web-3d-asset-pipeline.md`
- Alternative engines: `./alternative-3d-engines.md`
